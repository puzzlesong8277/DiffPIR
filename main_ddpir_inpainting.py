...
def main():
    ...
    testset_name            = 'y_color_correction_256'        # set testing set, 'imagenet_val' | 'ffhq_val'
    num_train_timesteps     = 1000
    iter_num                = 20              # set number of iterations
    iter_num_U              = 1                 # set number of inner iterations, default: 1
    skip                    = num_train_timesteps//iter_num     # skip interval

    mask_name               = 'testsets/mask256/'   # mask path for loading mask img
    load_mask               = True
    ...
    def test_rho(lambda_=lambda_,model_out_type_=model_out_type,zeta=zeta):
        ...
        for idx, img in enumerate(L_paths):
            ...
            mask_path = os.path.join(mask_name, img_name +'.png')  
            #print(mask_path)
